  ...
  return (
    <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
      {displayBounties.map((bounty) => (
        <div 
          key={bounty._id} 
          className="border border-[#1E1E2E] bg-black p-6 hover:border-[#22C55E]/50 transition-colors group flex flex-col relative overflow-hidden"
        >
          {/* Status Badge */}
          ...
          {/* Footer details (Fixed the duplicate here!) */}
